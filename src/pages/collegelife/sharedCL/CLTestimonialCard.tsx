...
function CLTestimonialCard({ id, name, major, year, description }: Props) {
    const isOdd = id % 2 === 1;

    return (
        <div
            className={`relative m-8 border-4 border-black h-96 w-96 rounded-md z-[-5] ${
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 border-b-solid border-b-[70px] border-r-[70px] border-r-transparent border-red-800 z-[-5]" />
            {/* Top Right Triangle */}
